...
from hyfi.constants import TOKEN_VOCAB, TYPE_VOCAB, COARSE_FLAG, FINE_FLAG, UF_FLAG
from hyfi.predictor import assign_types
from hyfi.evaluate import COARSE
...
class InstancePrinter(object):
    ...
    def __init__(self, vocabs, model):
